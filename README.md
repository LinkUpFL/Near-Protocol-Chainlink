...
- Create a MockV3Aggregator contract that matches the one used in EAC tests (MockV3Aggregator) (IN PROGRESS 80%). 
...
- Refactor smart contracts into traits/implementations for composability.